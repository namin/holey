...
```mermaid
flowchart TB
    PythonCode["<b>Python Code</b><br><tt>def sat(x): return x > 5</tt>"]
    SymbolicExecution["<b>Symbolic Execution</b><br>Overloaded Operations<br>Symbolic Variables"]
    SMTGeneration["<b>SMT Constraint Generation</b><br>Constraints Built as Side Effect<br><tt>(x > 5)</tt>"]
    SMTSolver["<b>SMT Solver</b><br>Z3 or other SMT solver<br>Find Values: <tt>x = 6</tt>"]

    PythonCode --> Dummy
    Dummy -.->| | SymbolicExecution
    Dummy -.->| | SMTGeneration
    SymbolicExecution --> SMTGeneration
    SymbolicExecution --- SMTSolver
    SMTGeneration --> SMTSolver
    SMTSolver -->|Return solution| PythonCode
